...
import play_icon from '../../assets/play-icon.png'; // Ensure the file extension is correct (e.g., '.png')
    ...
    <div className="about">
      ...
      <div className="about-right">
        ...
        <p>
          ...
          Our cutting-edge curriculum is designed to empower students with the knowledge, skills, and experiences needed to excel 
